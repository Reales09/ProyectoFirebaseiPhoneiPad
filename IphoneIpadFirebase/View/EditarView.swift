...
//  IphoneIpadFirebase
//
//  Created by Reales Rectoro Myles Clarence on 22/05/24.
//
                    ...
                    if imageData.count != 0 {
                        ...
                        Button(action:{
                            if imageData.isEmpty{
                                guardar.edit(titulo: titulo, desc: desc, plataforma: plataforma, id: datos.id, completion: {(done) in
                                    if done{
                                ...
                                progress = true
                                guardar.editWithImage(titulo: titulo, desc: desc, plataforma: plataforma, id: datos.id, index: datos, portada: imageData, completion: {(done) in
                                    if done{
                                        presentationMode.wrappedValue.dismiss()
                                    }
                                }
